use ast::types::{
    ...
    AstFile, AstFor, AstForEnhanced, AstIf, AstIfContent, AstInterfaceConstant, AstLambda,
    AstLambdaRhs, AstMethodParamerter, AstPoint, AstRange, AstRecursiveExpression, AstSwitch,
