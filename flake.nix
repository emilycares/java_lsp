        ...
        fileSetForCrate =
          ...
          lib.fileset.toSource {
            ...
            fileset = lib.fileset.unions [
              ...
              (craneLib.fileset.commonCargoSources ./crates/definition)
              (craneLib.fileset.commonCargoSources ./crates/hover)
              (craneLib.fileset.commonCargoSources ./crates/code_action)
              (craneLib.fileset.commonCargoSources ./crates/document_link)
              (craneLib.fileset.commonCargoSources ./crates/completion)
              (craneLib.fileset.commonCargoSources ./crates/inlay_hint)
              (craneLib.fileset.commonCargoSources ./crates/folding_range)
              (craneLib.fileset.commonCargoSources ./crates/code_lens)
              (craneLib.fileset.commonCargoSources ./crates/command)
