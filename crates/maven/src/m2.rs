...
#[must_use]
pub fn pom_classes_jar(pom: &Pom, pom_mtwo: &PomMTwo) -> PathBuf {
    pom_m2_classifier_path(pom, pom_mtwo, None)
}
#[must_use]
pub fn pom_sources_jar(pom: &Pom, pom_mtwo: &PomMTwo) -> PathBuf {
    pom_m2_classifier_path(pom, pom_mtwo, Some("sources"))
}
#[must_use]
pub fn pom_javadoc_jar(pom: &Pom, pom_mtwo: &PomMTwo) -> PathBuf {
    pom_m2_classifier_path(pom, pom_mtwo, Some("javadoc"))
}

#[must_use]
fn pom_m2_classifier_path(pom: &Pom, pom_mtwo: &PomMTwo, classifier: Option<&str>) -> PathBuf {
...
#[must_use]
pub fn pom_m2_sha1(pom: &Pom, pom_mtwo: &PomMTwo) -> PathBuf {
...
#[must_use]
pub fn pom_m2(pom: &Pom, m2: &Path) -> PomMTwo {
...
mod tests {
    ...
    use crate::{
        m2::{pom_javadoc_jar, pom_m2, pom_sources_jar},
        tree::{DependencyScope, Pom},
    };
