...
fn parser(cut: &str) -> Vec<Dependency> {
    ...
    for line in cut.lines() {
            ...
            && !a.ends_with(';')
        {
            out.push(Dependency {
                ...
                version: a.to_string(),
                version_suffix: Some(version.to_string()),
            });
            continue;
        }
...
mod tests {
    ...
    #[test]
    fn parse_diagram_jakara_version() {
        // Files in m2
        // querydsl-apt-5.1.0-jakarta.jar
        // querydsl-apt-5.1.0-jakarta.jar.lastUpdated
        // querydsl-apt-5.1.0-jakarta.jar.sha1
        // querydsl-apt-5.1.0-sources.jar
        // querydsl-apt-5.1.0-sources.jar.sha1
        // querydsl-apt-5.1.0.pom
        // querydsl-apt-5.1.0.pom.lastUpdated
        // querydsl-apt-5.1.0.pom.sha1
        let inp = include_str!("../tests/tree-jakarta.txt");
        ...
        assert_eq!(
            ...
            vec![
                Dependency {
                    ...
                    version: "33.4.8-jre".to_string(),
                    version_suffix: None,
                },
                Dependency {
                    group_id: "com.querydsl".to_string(),
                    artivact_id: "querydsl-apt".to_string(),
                    version: "5.1.0".to_string(),
                    version_suffix: Some("jakarta".to_string()),
                },
                Dependency {
                    group_id: "com.querydsl".to_string(),
                    artivact_id: "querydsl-jpa".to_string(),
                    version: "5.1.0".to_string(),
                    version_suffix: Some("jakarta".to_string()),
                },
                Dependency {
                    group_id: "com.querydsl".to_string(),
                    artivact_id: "querydsl-core".to_string(),
                    version: "5.1.0".to_string(),
                    version_suffix: None,
                },
                Dependency {
                    group_id: "jakarta.persistence".to_string(),
                    artivact_id: "jakarta.persistence-api".to_string(),
