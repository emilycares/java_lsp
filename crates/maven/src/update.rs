...
use common::{
    ...
    deps::{
        DepsBas, DepsSource, deps_base, deps_get_cfc, deps_get_etag, deps_get_hash, deps_get_source,
    },
    deps_dir,
};
...
pub async fn fetch_extract_source(
    f_source: Arc<PathBuf>,
...
#[must_use]
pub fn pom_source_jar_url(pom: &Dependency, repo: &str) -> String {
    format!(
        "{repo}{}/{}/{}/{}-{}-sources.jar",
        pom.group_id.replace('.', "/"),
        pom.artivact_id,
