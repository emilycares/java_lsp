...
use crate::{FormatError, FormatLineError};

pub fn google_java_format(content: &[u8]) -> Result<Option<Vec<u8>>, FormatError> {
...
pub fn google_java_format_parse_errors(errors: &str) -> Result<Vec<FormatLineError>, FormatError> {
    let mut out = Vec::new();
...
mod tests {
    ...
    use crate::google::google_java_format_parse_errors;
